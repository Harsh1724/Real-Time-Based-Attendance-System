    ...
    if faceCurFrame:
        ...
        if counter != 0:
            if counter == 1:
                ...
                studentInfo = db.get_student(id)
                print(studentInfo)

                # Get the Image from local storage
                imgStudent = db.get_image(id)
            ...
            if modeType != 3:
                ...
                if counter <= 10 and studentInfo:
                    ...
                    cv2.putText(imgBackground, str(id), (1006, 493),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['Roll']), (875, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                    cv2.putText(imgBackground, str(studentInfo['year']), (1020, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                    cv2.putText(imgBackground, str(studentInfo['starting_year']), (1155, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
